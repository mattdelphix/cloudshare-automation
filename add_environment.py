...
parser.add_argument("--project_name", type=str, required=True, help="Project Name to crete the environment on")
...
parser.add_argument("--blueprint_name", type=str, required=True, help="Blueprint Name to create new environment from")
